...
contract LiquidityManagerTest is Test {
    ...
    function test_ProvideLiquidity() public {
        ...
        vm.startPrank(owner);
        liquidityManager.provideLiquidity(owner, bottomTick, topTick, liquidityDesired, "");
        vm.stopPrank();
    ...
    function test_WithdrawLiquidity() public {
        ...
        // Then withdraw it
        liquidityManager.withdrawLiquidity(owner, bottomTick, topTick, liquidityDesired, amount0Min, amount1Min);
        vm.stopPrank();
